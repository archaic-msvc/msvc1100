...
#define DISPID_METRO_TEMPLATE_PRINTER           (DISPID_TEMPLATE_PRINTER+500)
...
//;begin_internal
#define DISPID_INTERNAL_ERRORPAGEREFRESHURL     (DISPID_A_FIRST+330)
#define DISPID_INTERNAL_ERRORPAGEREASON         (DISPID_A_FIRST+331)
#define DISPID_INTERNAL_ERRORPAGEDWNPOST        (DISPID_A_FIRST+332)
//;end_internal
...
//    DISPIDs for interface IMetroTemplatePrinter

#define DISPID_IMETROTEMPLATEPRINTER_STARTPRINT                   DISPID_METRO_TEMPLATE_PRINTER
#define DISPID_IMETROTEMPLATEPRINTER_DRAWPREVIEWPAGE              DISPID_METRO_TEMPLATE_PRINTER+1
#define DISPID_IMETROTEMPLATEPRINTER_SETPAGECOUNT                 DISPID_METRO_TEMPLATE_PRINTER+2
#define DISPID_IMETROTEMPLATEPRINTER_INVALIDATEPREVIEW            DISPID_METRO_TEMPLATE_PRINTER+3
#define DISPID_IMETROTEMPLATEPRINTER_GETPRINTTASKOPTIONVALUE      DISPID_METRO_TEMPLATE_PRINTER+4
#define DISPID_IMETROTEMPLATEPRINTER_ENDPRINT                     DISPID_METRO_TEMPLATE_PRINTER+5
