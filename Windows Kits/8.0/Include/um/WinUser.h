...
/*
 * Sent when an IME makes an automatic conversion from entered keystrokes
 * and inserts a character into the text container with keyboard focus.
 *     HWND             is the hwnd of the IME window
 *     idChild          is the Unicode value of the character entered
 *     idObject         is a bitfield
 *         0x00000001: set if a 32-bit Unicode surrogate pair is used
 */
#define EVENT_SYSTEM_IME_CHAR_COMMIT    0x002A
