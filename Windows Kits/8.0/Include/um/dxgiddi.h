...
typedef enum DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_TYPE
{
    DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_CAPS_BRIGHTNESS         = 0x1,
    DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_CAPS_CONTRAST           = 0x2,
    DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_CAPS_HUE                = 0x4,
    DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_CAPS_SATURATION         = 0x8,
    DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_CAPS_STRETCH_QUALITY    = 0x10,
} DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_TYPE;

typedef struct DXGI_DDI_MULTIPLANE_OVERLAY_CAPS
{
    UINT MaxPlanes;
    UINT OverlayCaps;        // DXGI_DDI_MULTIPLANE_OVERLAY_FEATURE_CAPS
    UINT FilterCaps;         // DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_TYPE
    UINT StereoCaps;         // DXGI_DDI_MULTIPLANE_OVERLAY_STEREO_CAPS
} DXGI_DDI_MULTIPLANE_OVERLAY_CAPS;

typedef struct DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_RANGE 
{
  INT   Minimum;
  INT   Maximum;
  INT   Default;
  FLOAT Multiplier;
} DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_RANGE;
...
typedef struct DXGI_DDI_MULITPLANE_OVERLAY_FILTER
{
    DXGI_DDI_MULTIPLANE_OVERLAY_FILTER_TYPE FilterType;
    BOOL Enabled;
    INT Value;
} DXGI_DDI_MULTIPLANE_OVERLAY_FILTER;
...
typedef struct DXGI_DDI_MULTIPLANE_OVERLAY_ATTRIBUTES
{
    ...
    UINT                                           NumFilters;
    DXGI_DDI_MULTIPLANE_OVERLAY_FILTER*            pFilters;
...
typedef struct DXGI1_2_DDI_BASE_FUNCTIONS
{
    ...
    HRESULT ( __stdcall /*APIENTRY*/ * pfnGetMultiPlaneOverlayFilterRange ) (DXGI_DDI_ARG_GETMULTIPLANEOVERLAYFILTERRANGE*);
