...
//
// User mode reboot information
//
#define SERVICE_USERMODEREBOOT_SHUTDOWN_VALIDATE_PHASE      0x00000001
#define SERVICE_USERMODEREBOOT_SHUTDOWN_EXECUTE_PHASE       0x00000002

typedef struct _SERVICE_USERMODEREBOOT_INFO {
    DWORD   dwFlags;            // Flags defined above which indicate the phase of UMR
    DWORD   eLowestRunLevel;    // Lowest run level for this User Mode Reboot
    DWORD   eHighestRunLevel;   // Highest run level for this User Mode Reboot
} SERVICE_USERMODEREBOOT_INFO, *PSERVICE_USERMODEREBOOT_INFO;
