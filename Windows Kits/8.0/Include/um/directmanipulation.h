...
enum DIRECTMANIPULATION_GESTURE_CONFIGURATION
    {
        ...
        DIRECTMANIPULATION_GESTURE_TAP	= 0x1,
        DIRECTMANIPULATION_GESTURE_SECONDARY_TAP	= 0x2,
        DIRECTMANIPULATION_GESTURE_HOLD	= 0x4,
...
#define DIRECTMANIPULATION_GESTURE_DEFAULT (DIRECTMANIPULATION_GESTURE_TAP | DIRECTMANIPULATION_GESTURE_SECONDARY_TAP | DIRECTMANIPULATION_GESTURE_HOLD)
typedef 
