...
#ifndef __ISignalableNotifierFactory_FWD_DEFINED__
#define __ISignalableNotifierFactory_FWD_DEFINED__
typedef interface ISignalableNotifierFactory ISignalableNotifierFactory;

#endif 	/* __ISignalableNotifierFactory_FWD_DEFINED__ */
...
#ifndef __ISignalableNotifierFactory_INTERFACE_DEFINED__
#define __ISignalableNotifierFactory_INTERFACE_DEFINED__

/* interface ISignalableNotifierFactory */
/* [unique][uuid][object] */ 


EXTERN_C const IID IID_ISignalableNotifierFactory;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("46305c32-09c6-45b2-b032-c12e467d7c7e")
    ISignalableNotifierFactory : public IUnknown
    {
    public:
    ...
    typedef struct ISignalableNotifierFactoryVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            __RPC__in ISignalableNotifierFactory * This,
            /* [in] */ __RPC__in REFIID riid,
        ...
        END_INTERFACE
    } ISignalableNotifierFactoryVtbl;

    interface ISignalableNotifierFactory
    {
        CONST_VTBL struct ISignalableNotifierFactoryVtbl *lpVtbl;
    };
...
#define ISignalableNotifierFactory_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ISignalableNotifierFactory_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ISignalableNotifierFactory_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ISignalableNotifierFactory_AttachToWaitHandle(This,waitableHandle,handler,pUnkOuter,riid,SignalNotifier)	\
    ( (This)->lpVtbl -> AttachToWaitHandle(This,waitableHandle,handler,pUnkOuter,riid,SignalNotifier) ) 

#define ISignalableNotifierFactory_AttachToWaitHandleWithTimeout(This,waitableHandle,handler,timeout,pUnkOuter,riid,SignalNotifier)	\
...
#endif 	/* __ISignalableNotifierFactory_INTERFACE_DEFINED__ */
