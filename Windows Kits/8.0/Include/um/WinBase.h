...
#include <threadpoolprivateapiset.h>
...
//
// Define enhanced mitigation policy options, which are split into a two bit
// enumeration and a two-bit reserved field (reserved field must be zero).
//

#define PROCESS_CREATION_MITIGATION_OPTION_ENHANCED_FIRST_OPTION 6
#define PROCESS_CREATION_MITIGATION_OPTION_ENHANCED_NUM_OPTIONS  4
...
//
// Structure definition for the extended (128-bit) File ID.
//
