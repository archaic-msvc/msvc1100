...
//      of type DEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT followed by a block of
//      one (or more) structures specific to that action.
//      Action-specific output buffer types are listed here:
//      - DeviceDsmAction_Trim:         None.
//      - DeviceDsmAction_Notification: None.
...
//      - DeviceDsmAction_Repair:       None.
//      - DeviceDsmAction_Scrub:        None.
//      - DeviceDsmAction_Resiliency:   None.
// Note:
...
typedef DWORD DEVICE_DATA_MANAGEMENT_SET_ACTION;
    ...
    #define DeviceDsmAction_Resiliency     (8 | DeviceDsmActionFlag_NonDestructive)
...
//
//  DeviceDsmAction_Resiliency specific flags
//

#define DEVICE_DSM_FLAG_RESILIENCY_START_RESYNC         0x10000000
#define DEVICE_DSM_FLAG_RESILIENCY_START_LOAD_BALANCING 0x20000000
...
typedef struct _DEVICE_DATA_SET_SCRUB_OUTPUT {
    ...
    DWORD BytesProcessed;                                       // Number of bytes that were actually processed
    DWORD BytesRepaired;                                        // Number of bytes that were out of sync and fixed
    DWORD BytesFailed;                                          // Number of bytes that could not be read or fixed
...
//
//  New File System FSCTL's should go here starting with 185
//
