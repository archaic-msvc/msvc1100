...
enum _CLUSTER_REG_COMMAND
    {
        ...
        CLUSREG_LAST_COMMAND	= ( CLUSREG_READ_ERROR + 1 ) 
    } 	CLUSTER_REG_COMMAND;
...
enum CLUSTER_PROPERTY_TYPE
    {
        ...
        CLUSPROP_TYPE_NODE_BITMASK	= ( CLUSPROP_TYPE_PARTITION_INFO_EX + 1 ) ,
        CLUSPROP_TYPE_NODE_NAME	= ( CLUSPROP_TYPE_NODE_BITMASK + 1 ) ,
        CLUSPROP_TYPE_DISK_HEADER_IDS	= ( CLUSPROP_TYPE_NODE_NAME + 1 ) ,
        CLUSPROP_TYPE_DISK_VALUES	= ( CLUSPROP_TYPE_DISK_HEADER_IDS + 1 ) ,
        CLUSPROP_TYPE_DISK_PRIV_PROPERTIES	= ( CLUSPROP_TYPE_DISK_VALUES + 1 ) ,
        CLUSPROP_TYPE_CSV_PARTITION_INFO_EX	= ( CLUSPROP_TYPE_DISK_PRIV_PROPERTIES + 1 ) ,
        CLUSPROP_TYPE_NODE_INDEX	= ( CLUSPROP_TYPE_CSV_PARTITION_INFO_EX + 1 ) ,
        CLUSPROP_TYPE_DISKID	= ( CLUSPROP_TYPE_NODE_INDEX + 1 ) ,
        CLUSPROP_TYPE_VOLUME_INFO	= ( CLUSPROP_TYPE_DISKID + 1 ) ,
        CLUSPROP_TYPE_POOL_INFO	= ( CLUSPROP_TYPE_VOLUME_INFO + 1 ) ,
        CLUSPROP_TYPE_POOL_PRIV_PROPERTIES	= ( CLUSPROP_TYPE_POOL_INFO + 1 ) ,
        CLUSPROP_TYPE_RESOURCE_ID	= ( CLUSPROP_TYPE_POOL_PRIV_PROPERTIES + 1 ) ,
        CLUSPROP_TYPE_DISK_SP_ID	= ( CLUSPROP_TYPE_RESOURCE_ID + 1 ) ,
...
enum CLUSTER_PROPERTY_SYNTAX
    {
        ...
        CLUSPROP_SYNTAX_CSV_PARTITION_INFO_EX	= ( DWORD  )(( ( CLUSPROP_TYPE_CSV_PARTITION_INFO_EX << 16 )  | CLUSPROP_FORMAT_BINARY ) ),
        CLUSPROP_SYNTAX_LIST_VALUE_FILETIME	= ( DWORD  )(( ( CLUSPROP_TYPE_LIST_VALUE << 16 )  | CLUSPROP_FORMAT_FILETIME ) ),
        CLUSPROP_SYNTAX_NODE_BITMASK	= ( DWORD  )(( ( CLUSPROP_TYPE_NODE_BITMASK << 16 )  | CLUSPROP_FORMAT_BINARY ) ),
        CLUSPROP_SYNTAX_NODE_LIST	= ( DWORD  )(( ( CLUSPROP_TYPE_NODE_NAME << 16 )  | CLUSPROP_FORMAT_MULTI_SZ ) ),
        CLUSPROP_SYNTAX_DISK_HEADER_IDS	= ( DWORD  )(( ( CLUSPROP_TYPE_DISK_HEADER_IDS << 16 )  | CLUSPROP_FORMAT_BINARY ) ),
        CLUSPROP_SYNTAX_DISK_VALUES	= ( DWORD  )(( ( CLUSPROP_TYPE_DISK_VALUES << 16 )  | CLUSPROP_FORMAT_VALUE_LIST ) ),
        CLUSPROP_SYNTAX_DISK_PRIV_PROPERTIES	= ( DWORD  )(( ( CLUSPROP_TYPE_DISK_PRIV_PROPERTIES << 16 )  | CLUSPROP_FORMAT_PROPERTY_LIST ) ),
        CLUSPROP_SYNTAX_NODE_INDEX	= ( DWORD  )(( ( CLUSPROP_TYPE_NODE_INDEX << 16 )  | CLUSPROP_FORMAT_DWORD ) ),
        CLUSPROP_SYNTAX_DISK_IDS	= ( DWORD  )(( ( CLUSPROP_TYPE_DISKID << 16 )  | CLUSPROP_FORMAT_VALUE_LIST ) ),
        CLUSPROP_SYNTAX_DISK_VOLUMES	= ( DWORD  )(( ( CLUSPROP_TYPE_VOLUME_INFO << 16 )  | CLUSPROP_FORMAT_VALUE_LIST ) ),
        CLUSPROP_SYNTAX_POOL_INFO	= ( DWORD  )(( ( CLUSPROP_TYPE_POOL_INFO << 16 )  | CLUSPROP_FORMAT_BINARY ) ),
        CLUSPROP_SYNTAX_POOL_PRIV_PROPERTIES	= ( DWORD  )(( ( CLUSPROP_TYPE_POOL_PRIV_PROPERTIES << 16 )  | CLUSPROP_FORMAT_PROPERTY_LIST ) ),
        CLUSPROP_SYNTAX_RESOURCE_ID	= ( DWORD  )(( ( CLUSPROP_TYPE_RESOURCE_ID << 16 )  | CLUSPROP_FORMAT_SZ ) ),
        CLUSPROP_SYNTAX_DISK_SP_ID	= ( DWORD  )(( ( CLUSPROP_TYPE_DISK_SP_ID << 16 )  | CLUSPROP_FORMAT_BINARY ) )
