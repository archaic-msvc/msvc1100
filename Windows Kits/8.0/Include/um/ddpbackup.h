...
EXTERN_C const IID IID_IDedupBackupSupport;
    ...
    MIDL_INTERFACE("0EF21B79-AE02-4C1A-877A-C9C65CBAF0C3")
    IDedupBackupSupport : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE RestoreFile( 
            /* [in] */ __RPC__in BSTR FileFullPath,
    ...
    typedef struct IDedupBackupSupportVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *RestoreFile )( 
            __RPC__in IDedupBackupSupport * This,
            /* [in] */ __RPC__in BSTR FileFullPath,
            /* [in] */ __RPC__in_opt IDedupReadFileCallback *Store,
            /* [in] */ DWORD Flags);
...
#define IDedupBackupSupport_RestoreFile(This,FileFullPath,Store,Flags)	\
    ( (This)->lpVtbl -> RestoreFile(This,FileFullPath,Store,Flags) ) 
