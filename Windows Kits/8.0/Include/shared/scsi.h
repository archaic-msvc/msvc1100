...
//
// Page code for the Logical Block Provisioning log page.
//
...
//
// This structure is common to all log parameter structures.  The interpretation
// of the successive Parameter Value is dependent upon the given Parameter Code.
//
typedef struct _LOG_PARAMETER_HEADER {
    ...
    UCHAR ParameterLength;  // The size in bytes of the parameter value.
