...
typedef struct _DEVICE_DATA_SET_SCRUB_OUTPUT {
    ...
    ULONG BytesProcessed;                                       // Number of bytes that were actually processed
    ULONG BytesRepaired;                                        // Number of bytes that were out of sync and fixed
    ULONG BytesFailed;                                          // Number of bytes that could not be read or fixed
