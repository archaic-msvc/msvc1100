...
extern const __declspec(selectany) WCHAR InterfaceName_Windows_Management_Core_IApplicationDataManagerStatics[] = L"Windows.Management.Core.IApplicationDataManagerStatics";
...
extern const __declspec(selectany) WCHAR InterfaceName_Windows_Management_Core_IApplicationDataManager[] = L"Windows.Management.Core.IApplicationDataManager";
...
extern const __declspec(selectany) WCHAR RuntimeClass_Windows_Management_Core_ApplicationDataManager[] = L"Windows.Management.Core.ApplicationDataManager";
#endif
