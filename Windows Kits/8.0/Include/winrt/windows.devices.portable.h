...
extern const __declspec(selectany) WCHAR InterfaceName_Windows_Devices_Portable_IStorageDeviceStatics[] = L"Windows.Devices.Portable.IStorageDeviceStatics";
                ...
                namespace Portable {
                    ...
                    public:
                        virtual HRESULT STDMETHODCALLTYPE FromId( 
                            /* [in] */ __RPC__in HSTRING interfaceId,
...
#define __x_ABI_CWindows_CDevices_CPortable_CIStorageDeviceStatics_FromId(This,interfaceId,deviceRoot)	\
    ( (This)->lpVtbl -> FromId(This,interfaceId,deviceRoot) ) 
...
extern const __declspec(selectany) WCHAR InterfaceName_Windows_Devices_Portable_IServiceDeviceStatics[] = L"Windows.Devices.Portable.IServiceDeviceStatics";
...
extern const __declspec(selectany) WCHAR RuntimeClass_Windows_Devices_Portable_StorageDevice[] = L"Windows.Devices.Portable.StorageDevice";
#endif
...
extern const __declspec(selectany) WCHAR RuntimeClass_Windows_Devices_Portable_ServiceDevice[] = L"Windows.Devices.Portable.ServiceDevice";
#endif
