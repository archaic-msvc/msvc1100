...
static const AsyncStatus Started = AsyncStatus::Started;
static const AsyncStatus Completed = AsyncStatus::Completed;
static const AsyncStatus Canceled = AsyncStatus::Canceled;
static const AsyncStatus Error = AsyncStatus::Error;
