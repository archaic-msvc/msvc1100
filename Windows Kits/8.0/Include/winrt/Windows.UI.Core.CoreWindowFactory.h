...
extern const __declspec(selectany) WCHAR InterfaceName_Windows_UI_Core_ICoreWindowFactory[] = L"Windows.UI.Core.ICoreWindowFactory";
...
extern const __declspec(selectany) WCHAR RuntimeClass_Windows_UI_Core_ImmersiveCoreWindowFactory[] = L"Windows.UI.Core.ImmersiveCoreWindowFactory";
#endif
#ifdef __cplusplus
namespace ABI {
namespace Windows {
...
extern const __declspec(selectany) WCHAR RuntimeClass_Windows_UI_Core_HostedCoreWindowFactory[] = L"Windows.UI.Core.HostedCoreWindowFactory";
#endif
