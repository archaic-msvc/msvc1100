...
extern const __declspec(selectany) WCHAR InterfaceName_Windows_Security_Cryptography_ICryptographicBufferStatics[] = L"Windows.Security.Cryptography.ICryptographicBufferStatics";
...
extern const __declspec(selectany) WCHAR RuntimeClass_Windows_Security_Cryptography_CryptographicBuffer[] = L"Windows.Security.Cryptography.CryptographicBuffer";
#endif
