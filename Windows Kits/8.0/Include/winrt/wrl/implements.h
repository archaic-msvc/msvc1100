...
#pragma warning(suppress: 6388) // PREFast cannot see through template instantiation for AsIID() 
...
public:
    ...
    STDMETHOD(GetRuntimeClassName)(_Out_ HSTRING*)
    {
...
class __declspec(novtable) RuntimeClass<ILst, RuntimeClassFlagsT, true, true, false> : 
    public Details::ImplementsHelper<RuntimeClassFlagsT, InterfaceList<typename ILst::FirstT, InterfaceList<IWeakReferenceSource, typename ILst::RestT> >, false>,
    public RuntimeClassBaseT<RuntimeClassFlagsT::value>,
    public DontUseNewUseMake
{
public:
