...
extern const __declspec(selectany) WCHAR InterfaceName_Windows_ApplicationModel_Infrastructure_ISetWindowWithWindowFactory[] = L"Windows.ApplicationModel.Infrastructure.ISetWindowWithWindowFactory";
