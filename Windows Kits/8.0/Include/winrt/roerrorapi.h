...
const int MAX_ERROR_MESSAGE_CHARS = 512; //not including the terminating null
...
const DWORD EXCEPTION_RO_ORIGINATEERROR = (DWORD)((0x1 << 30) | (FACILITY_WINDOWS << 16) | 0x201);  //0x40080201L
const DWORD EXCEPTION_RO_TRANSFORMERROR = (DWORD)((0x1 << 30) | (FACILITY_WINDOWS << 16) | 0x202);  //0x40080202L
