...
#define	DISPID_METHOD_REMOTEDESKTOPCLIENT_DELETE_SAVED_CREDENTIALS	( 703 )
...
#define	DISPID_METHOD_REMOTEDESKTOPCLIENT_EXECUTE_LOCAL_ACTION	( 733 )

#define	DISPID_METHOD_REMOTEDESKTOPCLIENT_GET_SNAPSHOT	( 734 )
...
typedef /* [public][public] */ 
enum __MIDL_IRemoteDesktopClientActions_0004
    {
        SnapshotFormatPng	= 0,
...
EXTERN_C const IID IID_IRemoteDesktopClientActions;
    ...
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE ExecuteLocalAction( 
            /* [in] */ LocalActionType localAction) = 0;
    ...
    typedef struct IRemoteDesktopClientActionsVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *ExecuteLocalAction )( 
            __RPC__in IRemoteDesktopClientActions * This,
            /* [in] */ LocalActionType localAction);
...
#define IRemoteDesktopClientActions_ExecuteLocalAction(This,localAction)	\
    ( (This)->lpVtbl -> ExecuteLocalAction(This,localAction) ) 
