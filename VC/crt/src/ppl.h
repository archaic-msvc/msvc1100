...
namespace details
{
    ...
    private:
        _CancellationTokenCallback & operator =(const _CancellationTokenCallback &);
...
/// <summary>
///     The <c>cancellation_token_registration</c> class represents a callback notification from a <c>cancellation_token</c>.
/// </summary>
/// <remarks>
///     When you use the <c>register</c> method on a <c>cancellation_token</c> to receive notification of when cancellation occurs,
///     a <c>cancellation_token_registration</c> object is returned as a handle to the callback so that you can request a specific
///     callback no longer be made through use of the <c>deregister</c> method.
///     <para>The <c>cancellation_token_registration</c> behaves like a smart pointer and is safe and efficient to pass around by value.</para>
/// </remarks>
/**/
...
public:
    /// <summary>
    ///     Constructs a <c>cancellation_token_registration</c> object.
    /// </summary>
    /// <remarks>
    ///     The default constructor creates an empty <c>cancellation_token_registration</c> object, which is not be valid until it is copied to or
    ///     assigned from a different valid <c>cancellation_token_registration</c>.
    ///     <para>As <c>cancellation_token_registration</c> behaves like a  smart pointer, after a copy construction, this objects represents the same
    ///     actual registration as <paramref name="_Src"/>.</para>
    /// </remarks>
    /**/
    ...
    /// </summary>
    /// <param name="_Src">
    ///     The source <c>cancellation_token_registration</c> object.
    /// </param>
    /// <remarks>
    ///     The default constructor creates an empty <c>cancellation_token_registration</c> object, which is not be valid until it is copied to or
    ///     assigned from a different valid <c>cancellation_token_registration</c>.
    ...
    /// <summary>
    ///     Destructs the <c>cancellation_token_registration</c> object.
    /// </summary>
    /**/
    ~cancellation_token_registration()
    {
    ...
    /// <summary>
    ///     Replaces the contents of one <c>cancellation_token_registration</c> object with another.
    /// </summary>
    /// <param name="_Src">
    ///     The source <c>cancellation_token_registration</c> object.
    /// </param>
    /// <remarks>
    ///     As <c>cancellation_token_registration</c> behaves like a  smart pointer, after a copy assignment, this objects represents the same
    ///     actual registration as <paramref name="_Src"/>.
    /// </remarks>
    /**/
    ...
    /// <summary>
    ///     Determines whether two <c>cancellation_token_registration</c> objects represent the same
    ///     cancellation token registration.
    /// </summary>
    /// <paramref name="_Rhs"/>
    ///     The <c>cancellation_token_registration</c> object to compare with.
    /// </param>
    /// <returns>
    ///     <c>true</c> if the two objects represent the same token registration, <c>false</c> otherwise.
    /// </returns>
    /**/
    ...
    /// <summary>
    ///     Determines whether two <c>cancellation_token_registration</c> objects represent two different
    ...
    /// </param>
    /// <returns>
    ///     <c>true</c> if the two objects represent two different token registrations, <c>false</c> otherwise.
    /// </returns>
    /**/
    bool operator!=(const cancellation_token_registration& _Rhs) const
    {
...
/// <summary>
///     The <c>cancellation_token</c> class represents the ability to determine whether some operation has been requested to cancel.
/// </summary>
/// <remarks>
///     Multiple <c>cancellation_token</c> objects can be linked to one <c>cancellation_token_source</c> object. When you call the
///     <see cref="cancellation_token::cancel Method">cancel</see> method on a token source, all the linked <c>cancellation_token</c> objects
///     are set as canceled.
///     <para>A given <c>cancellation_token</c> object can be associated with a <c>task_group</c>, <c>structured_task_group</c>, or <c>task</c>
///     to provide implicit cancellation. It can also be polled for cancellation information or have a callback registered and called when it is canceled.</para>
///     <para><c>cancellation_token</c> behaves like a smart pointer and is safe to pass around by value.</para>
/// </remarks>
/**/
class cancellation_token
{
public:
    ...
    /// </returns>
    /// <remarks>
    ///     The <c>none()</c> token can be explicitly assigned to a <c>task_group</c> or <c>structured_task_group</c>
    ///     to block the implicit cancellation propagation from a parent construct. In conjuction with <see cref="run_with_cancellation_token Function">
    ///     run_with_cancellation_token</see>, it can also be used to safe guard parallel algorithms from unintended cancellation from above.
    /// </remarks>
    /**/
    ...
    /// <summary>
    ///     Constructs a <c>cancellation_token</c> object.
    /// </summary>
    /// <param name="_Src">
    ///     The source <c>cancellation_token</c> object.
    /// </param>
    /// <remarks>
    ///     As <c>cancellation_token</c> behaves like a smart pointer, after a copy construction, this object represents the same
    ///     internal object as <paramref name="_Src"/> does.
    /// </remarks>
    /**/
    ...
    /// <summary>
    ///     Replaces the contents of one <c>cancellation_token</c> object  with another.
    /// </summary>
    /// <param name="_Src">
    ///     The source <c>cancellation_token</c> object.
    /// </param>
    /// <remarks>
    ///     As <c>cancellation_token</c> behaves like a smart pointer, after a copy assignment, this object represents the same
    ///     internal object as <paramref name="_Src"/> does.
    /// </remarks>
    /**/
    ...
    /// <summary>
    ///     Determines whether two <c>cancellation_token</c> objects represent the same underlying token.
    /// </summary>
    /// <paramref name="_Rhs"/>
    ///     The <c>cancellation_token</c> object to compare with.
    /// </param>
    /// <returns>
    ///     <c>true</c> if the two objects represent the same underlying token, <c>false</c> otherwise.
    /// </returns>
    /**/
    bool operator==(const cancellation_token& _Rhs) const
    {
        return _M_Impl == _Rhs._M_Impl;
    }

    /// <summary>
    ///     Determines whether two <c>cancellation_token</c> objects represent two different underlyign tokens.
    /// </summary>
    /// <paramref name="_Rhs"/>
    ///     The <c>cancellation_token</c> object to compare with.
    /// </param>
    /// <returns>
    ///     <c>true</c> if the two objects represent different underlying tokens, <c>false</c> otherwise.
    /// </returns>
    /**/
    bool operator!=(const cancellation_token& _Rhs) const
    {
    ...
    /// <summary>
    ///     Destructs the <c>cancellation_token</c> object.
    /// </summary>
    /**/
    ~cancellation_token()
    {
    ...
    /// <summary>
    ///     Registers a callback function with the token. If and when the token is canceled, the callback will be invoked. If the token
    ///     is already canceled at the point where this method is called, the callback is invoked immediately and synchronously.
    /// </summary>
    /// <typeparam name="_Function">
    ///     The type of the function object that will be invoked when this <c>cancellation_token</c> is canceled.
    /// </typeparam>
    /// <param name="_Func">
    ///     The function object that will be invoked when this <c>cancellation_token</c> is canceled.
    /// </param>
    /// <returns>
    ...
    /**/
    template<typename _Function>
    cancellation_token_registration register_callback(const _Function& _Func) const
    {
        if (_M_Impl == NULL)
        {
...
/// <summary>
///     The <c>cancellation_token_source</c> class represents the ability to cancel an operation.
/// </summary>
/// <remarks>
///     The <c>cancellation_token_source</c> can be used to request cancellation of a cancelable operation.
///     <para>Use the <see cref="cancellation_token_source::cancel Method">cancel</see> method, to set all <c>cancellation_token</c>'s associated with
///     this <c>cancellation_toekn_source</c> as canceled.</para>
///     <para><c>cancellation_token_source</c> behaves like a smart pointer and is safe to pass around by value.</para>
/// </remarks>
/**/
class cancellation_token_source
{
public:
    ...
    /// <summary>
    ///     Constructs a <c>cancellation_token_source</c> object.
    /// </summary>
    /// <remarks>
    ///     The default constructor creates a new token source with no linked cancellation tokens.
    ///     <para>As <c>cancellation_token_source</c> behaves like a smart pointer, after a copy construction, the new object represents
    ///     the same token source as <paramref name="_Src"/> does.</para>
    /// </remarks>
    /**/
    cancellation_token_source()
    {
        _M_Impl = ::Concurrency::details::_CancellationTokenState::_NewTokenState();
    }
    ...
    /// </summary>
    /// <param name="_Src">
    ///     The source <c>cancellation_token</c> object that copy or move from.
    /// </param>
    /// <remarks>
    ///     The default constructor creates a new token source with no linked cancellation tokens.
    ///     <para>As <c>cancellation_token_source</c> behaves like a smart pointer, after a copy construction. the new object represents
    ...
    /// <summary>
    ///     Replaces the contents of one <c>cancellation_token_source</c> object with another.
    /// </summary>
    /// <param name="_Src">
    ///     The source <c>cancellation_token_source</c> object.
    /// </param>
    /// <remarks>
    ///     As <c>cancellation_token_source</c> behaves like a smart pointer, after a copy assignment. this object represents
    ///     the same token source as <paramref name="_Src"/> does.
    /// </remarks>
    /**/
    ...
    /// <summary>
    ///     Determines whether two <c>cancellation_token_source</c> objects represent the same token source.
    /// </summary>
    /// <paramref name="_Rhs"/>
    ///     The <c>cancellation_token_source</c> object to compare with.
    /// </param>
    /// <returns>
    ///     <c>true</c> if the two objects represent the same underlying token source, <c>false</c> otherwise.
    /// </returns>
    /**/
    bool operator==(const cancellation_token_source& _Rhs) const
    {
        return _M_Impl == _Rhs._M_Impl;
    }

    /// <summary>
    ///     Determines whether two <c>cancellation_token_source</c> objects represent two different token sources.
    /// </summary>
    /// <paramref name="_Rhs"/>
    ///     The <c>cancellation_token_source</c> object to compare with.
    /// </param>
    /// <returns>
    ///     <c>true</c> if the two objects represent different underlying token sources, <c>false</c> otherwise.
    /// </returns>
    /**/
    bool operator!=(const cancellation_token_source& _Rhs) const
    {
    ...
    /// <summary>
    ///     Destructs the <c>cancellation_token_source</c> object.
    /// </summary>
    ~cancellation_token_source()
    {
        if (_M_Impl != NULL)
    ...
    /// <summary>
    ///     Creates a <c>cancellation_token_source</c> which will be canceled when an input token is canceled.
    /// </summary>
    /// <param name="_Src">
    ///     A token whose cancellation will cause cancellation of the returned token source. You may cancel the returned token source independently
    ///     of the token source for the passed in token.
    /// </param>
    /// <returns>
    ///     A <c>cancellation_token_source</c> which is canceled when any token provided as an input is canceled.
    /// </returns>
    /// <remarks>
    ///     By default, a <c>cancellation_token</c> is controlled by its associated <c>cancellation_token_source</c>. Use this method when you want to cascade
    ///     cancellation from one <c>cancellation_token</c> to another <c>cancellation_token_source</c> and its associated cancellation tokens.
    ///     <para>The version of this method that takes an iterator range, will create a <c>cancellation_token_source</c> linked to all
    ///     <c>cancellation_token</c>s in that interater range.</para>
    /// </remarks>
    /**/
...
public:
    ...
    template<class _Type>
    _Type _Get_num_chunks(_Type _Range) const
    {
        static_assert(sizeof(_Type) <= sizeof(_Size_type), "Potential truncation of _Range");
        _Size_type _Num_chunks = (static_cast<_Size_type>(_Range) / _M_chunk_size);
...
void _Parallel_chunk_impl(const _Random_iterator& _First, _Index_type _Range, const _Index_type& _Step, const _Function& _Func)
{
    _Parallel_chunk_impl<_Worker_class>(_First, _Range, _Step, _Func, auto_partitioner());
}
...
void _Parallel_for_partitioned_impl(_Index_type _First, _Diff_type _Range, _Diff_type _Step, const _Function& _Func, const auto_partitioner& _Part)
{
...
template <typename _Index_type, typename _Diff_type, typename _Function>
void _Parallel_for_partitioned_impl(_Index_type _First, _Diff_type _Range, _Diff_type _Step, const _Function& _Func, const static_partitioner& _Part)
{
...
template <typename _Index_type, typename _Diff_type, typename _Function>
void _Parallel_for_partitioned_impl(_Index_type _First, _Diff_type _Range, _Diff_type _Step, const _Function& _Func, const simple_partitioner& _Part)
{
...
template <typename _Index_type, typename _Diff_type, typename _Function>
void _Parallel_for_partitioned_impl(_Index_type _First, _Diff_type _Range, _Diff_type _Step, const _Function& _Func, affinity_partitioner& _Part)
{
...
template <typename _Random_iterator, typename _Index_type, typename _Function>
void _Parallel_for_each_partitioned_impl(const _Random_iterator& _First, _Index_type _Range, _Index_type _Step, const _Function& _Func, const auto_partitioner& _Part)
{
...
template <typename _Random_iterator, typename _Index_type, typename _Function>
void _Parallel_for_each_partitioned_impl(const _Random_iterator& _First, _Index_type _Range, _Index_type _Step, const _Function& _Func, const static_partitioner& _Part)
{
...
template <typename _Random_iterator, typename _Index_type, typename _Function>
void _Parallel_for_each_partitioned_impl(const _Random_iterator& _First, _Index_type _Range, _Index_type _Step, const _Function& _Func, const simple_partitioner& _Part)
{
...
template <typename _Random_iterator, typename _Index_type, typename _Function>
void _Parallel_for_each_partitioned_impl(const _Random_iterator& _First, _Index_type _Range, _Index_type _Step, const _Function& _Func, affinity_partitioner& _Part)
{
...
void _Parallel_for_each_impl(const _Random_iterator& _First, const _Random_iterator& _Last, const _Function& _Func, _Partitioner&& _Part, std::random_access_iterator_tag)
{
    ...
    else
    {
        ...
        _Parallel_for_each_partitioned_impl(_First, _Range, _Step, _Func, std::forward<_Partitioner>(_Part));
   }
}
...
///     In most cases parallel_buffered_sort will show an improvement in performance over <see cref="parallel_sort Function">parallel_sort</c>, and you should
...
{
    parallel_buffered_sort<_Allocator>(_Alloc, _Begin, _End, std::less<std::iterator_traits<_Random_iterator>::value_type>());
}
