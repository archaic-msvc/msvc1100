...
namespace Platform
{
	...
	VCCORLIB_API Platform::String^ Guid::ToString()
	{
		...
		swprintf_s(buf,L"{%08x-%04hx-%04hx-%02hhx%02hhx-%02hhx%02hhx%02hhx%02hhx%02hhx%02hhx}", __a, __b, __c, __d, __e, __f, __g, __h, __i, __j, __k);
		return ref new Platform::String(buf);
	}
