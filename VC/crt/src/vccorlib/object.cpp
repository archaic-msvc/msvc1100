...
{
    CPPCLI_FUNC Platform::String^ __stdcall __abi_ObjectToString(Platform::Object^ o)
	{
		return __abi_ObjectToString(o, false);
	}
    ...
    CPPCLI_FUNC Platform::String^ __stdcall __abi_ObjectToString(Platform::Object^ o, bool useIPrintable)
    {
		...
		{
			HSTRING h;
			hr = pInspectable->GetRuntimeClassName(&h);
			if (SUCCEEDED(hr))
			{
				Platform::String^ s = ref new Platform::String(::WindowsGetStringRawBuffer(h, nullptr));
				return s;
			}
		}
