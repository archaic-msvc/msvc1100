...
namespace details
{
    ...
    public:
        ...
        {
            // @TODO: At some point when RM honors process affinity, etc..., go back and ensure that this is the correct value to return!
            return m_nodeCount;
        }
    ...
    private:
        ...
        static const unsigned int ReleaseCoresDownToMin = -1;
