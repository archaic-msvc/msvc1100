...
#if defined(_M_ARM) || defined(_M_X64) || defined(_M_IX86)
#define USE_ICX64   1
...
namespace details
{
    ...
    _CRTIMP void _ConcRT_CCMTrace(int traceevt, ULONG_PTR data);
    _CRTIMP void _ConcRT_CCMSTrace(int traceevt, ULONG_PTR data);
