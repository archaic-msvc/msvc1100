...
__MACHINEARM_X64(void * _InterlockedCompareExchangePointer(void * volatile * _Destination, void * _Exchange, void * _Comparand))
...
__MACHINEARM_X64(void * _InterlockedExchangePointer(void * volatile * _Target, void * _Value))
