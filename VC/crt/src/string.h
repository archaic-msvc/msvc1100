...
#endif  /* __STDC_WANT_SECURE_LIB__ */
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(errno_t, strcat_s, _Prepost_z_ char, _Dest, _In_z_ const char *, _Source)
...
#endif  /* __STDC_WANT_SECURE_LIB__ */
__DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1(errno_t, wcscat_s, _Prepost_z_ wchar_t, _Dest, _In_z_ const wchar_t *, _Source)
