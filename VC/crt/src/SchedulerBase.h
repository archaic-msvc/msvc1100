...
namespace details
{
    ...
    public:  // Internal stuff
        ...
        ULONG ThrottlingDelta()
        {
            ...
            ULONG delta = curTime - m_lastThrottledCreateTime;
        ...
        {
            m_lastThrottledCreateTime = GetTickCount();
        }
        ...
        /// </summary>
        void PeriodicScan(ULONG serviceTime)
        {
            //
        ...
        //**************************************************
        //
        // @TODO: This is temporary until such time as we can hook into priority to solve livelock issues.
        //
    ...
    private:
        ...
        //
        // @TODO: This is a temporary patch for livelock prevention until we can hook into priority.
        // @TODO: This **MUST** have a hyper lock on it.
        //
        ...
        volatile ULONG m_lastServiceScan;
        ...
        ULONG m_lastThrottledCreateTime;
        ...
        /// </summary>
        void PerformServiceScan(ULONG serviceTime);

        /// <summary>
        ///     A simple bridge to ThrottlerDispatch.
        /// </summary>
        static void CALLBACK ThrottlerDispatchBridge(PVOID pScheduler, BOOLEAN waitOrTimerFired)
        {
