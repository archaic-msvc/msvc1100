...
#include "kxarm.h"
        ...
        bx      r3                                      ; go there
1
        bl.w    __rt_divby0                             ; exception if zero
...
9
        ...
        bleq.w  __rt_divby0                             ; exception if zero
        ...
        cmp     r3, #0                                  ; is upper word of dividend 0?
        clzne   r1, r3                                  ; if not, get zero count of high word
        clzeq   r1, r2                                  ; else get zero count of low word
        addeq   r1, r1, #32                             ; plus 32

        cmp     r12, #0                                 ; is upper word of divisor 0?
        clzne   r0, r12                                 ; if not, get zero count of high word
        clzeq   r0, r6                                  ; else get zero count of low word
        addeq   r0, r0, #32                             ; plus 32
        ...
        movhs   r5, r6                                  ; if so, preshift by shifting words
        movhs   r4, #0                                  ; 
        movlo   r5, r12                                 ; otherwise, copy original values
        movlo   r4, r6                                  ;
...
9
        ...
        NESTED_ENTRY __rt_divby0
        PROLOG_PUSH     {r11,lr}                        ; save registers

        bl      __helper_divide_by_0                    ; call our helper function
        movs    r0, #-1                                 ; return a maximal result

        EPILOG_POP      {r11,pc}                        ; and return
        NESTED_END __rt_divby0
