...
namespace details
{
    ...
    public:
        ...
        {
            return m_hasTimer && CreateTimerQueueTimer(&m_hTimer, 
                                GetSharedTimerQueue(), 
                                TimedSingleWaitBlock::DispatchEventTimer, 
                                this, 
                                timerout, 
                                0, 
    ...
    /// </summary>
    void TimedSingleWaitBlock::DispatchEventTimer(LPVOID pContext, BOOLEAN)
    {
