        ...
        )
{
    ...
    return LCMapStringEx( LocaleName, dwMapFlags, lpSrcStr, cchSrc,
                         lpDestStr, cchDest, NULL /* Reserved; must be NULL */, NULL /* Reserved; must be NULL */, 0 /* Reserved; must be 0 */);
}
