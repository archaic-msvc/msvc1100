...
/***
*convert_path_to_wide_string() - Convert an ANSI/MBCS path to wide char string.
*
*Entry:
...
*
*Exit:
*       outPath point to wide char output string
...
*
*******************************************************************************/
BOOL __cdecl convert_path_to_wide_string (
        const char *path,
        wchar_t **outPath
        )
{
