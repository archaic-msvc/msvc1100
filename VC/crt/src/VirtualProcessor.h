...
{
    //
    // @TODO: This is **TEMPORARY** until priority based livelock prevention is real.
    //
    ...
    public:
        ...
        //
        // @TODO: This goes with real priority.
        //
        ...
        /// </summary>
        void ServiceMark(ULONG markTime)
        {
            //
        ...
        /// </summary>
        ULONG TimeSinceServicing(ULONG markTime)
        {
            return markTime - m_lastServiceTime;
        }
    ...
    private:
        ...
        ULONG m_lastServiceTime;

        //
        // @TODO: This is a temporary patch on livelock until we can tie into priority for livelock prevention.
        //
