...
#if (defined(_M_IA64) || defined(_M_AMD64) || defined(_M_ARM_NT))
...
#if _M_MRX000 >= 4000 || defined(_M_MPPC) || defined(_M_PPC) || defined(_M_IA64) || defined(_M_AMD64) || defined(_M_ARM)	 /*IFSTRIP=IGN*/
