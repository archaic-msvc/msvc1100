...
#ifdef UNICODE
	hr = SHCreateItemFromParsingName(lpszPathName, NULL, IID_IShellItem, reinterpret_cast<void**>(&psi));
#else
	{
		USES_CONVERSION;
		LPOLESTR lpWPath = A2W(lpszPathName);
		hr = SHCreateItemFromParsingName(lpWPath, NULL, IID_IShellItem, (LPVOID*)&psi);
	}
#endif
